 ...
 * classes to create to prevent possible remote code invocation when the data comes from an
 * untrusted source. The standard tags are always allowed (https://yaml.org/type/index.html)
 */
